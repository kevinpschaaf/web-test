  ...
  */
  ...
  function p(a) {
    a = a.replace(aa, "").replace(ba, "");var b = q,
        c = a,
        d = new m();d.start = 0;d.end = c.length;for (var e = d, f = 0, h = c.length; f < h; f++) {
      if ("{" === c[f]) {
        e.rules || (e.rules = []);var g = e,
            k = g.rules[g.rules.length - 1] || null,
            e = new m();e.start = f + 1;e.parent = g;e.previous = k;g.rules.push(e);
      } else "}" === c[f] && (e.end = f + 1, e = e.parent || d);
    }return b(d, a);
  }
  function q(a, b) {
    var c = b.substring(a.start, a.end - 1);a.parsedCssText = a.cssText = c.trim();a.parent && ((c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = ca(c), c = c.replace(r, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = !c.indexOf("@"), a.atRule) ? c.indexOf("@media") ? c.match(da) && (a.type = u, a.keyframesName = a.selector.split(r).pop()) : a.type = t : a.type = c.indexOf("--") ? v : y);if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) {
      q(f, b);
    }return a;
  }
  function ca(a) {
  ...
  var v = 1,
    ...
    if (a = l[a]) a._applyShimCurrentVersion = a._applyShimCurrentVersion || 0, a._applyShimValidatingVersion = a._applyShimValidatingVersion || 0, a._applyShimNextVersion = (a._applyShimNextVersion || 0) + 1;
  }function A(a) {
  ...
  };var B = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:([^;{]*)|{([^}]*)})(?:(?=[;\s}])|$)/gi,
      C = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,
      la = /@media[^(]*(\([^)]*\))/;var D = !(window.ShadyDOM && window.ShadyDOM.inUse),
      E = !navigator.userAgent.match("AppleWebKit/601") && window.CSS && CSS.supports && CSS.supports("box-shadow", "0 0 0 var(--foo)");function F(a) {
    a && (E = E && !a.nativeCss && !a.shimcssproperties, D = D && !a.nativeShadow && !a.shimshadow);
  }window.ShadyCSS ? F(window.ShadyCSS) : window.WebComponents && F(window.WebComponents.flags);var ma = D,
      G = E;function H(a) {
    if (!a) return "";"string" === typeof a && (a = p(a));return z(a, G);
  }function I(a) {
    ...
    if (a) {
      ...
      }f === v ? b(a) : c && f === u ? c(a) : f === y && (e = !0);if ((a = a.rules) && !e) for (var e = 0, f = a.length, g; e < f && (g = a[e]); e++) {
        J(g, b, c, d);
      }
    }
  }
  function K(a, b) {
    ...
    a = C.test(a) || B.test(a);C.lastIndex = 0;B.lastIndex = 0;return a;
  ...
  function pa(a, b) {
    b = b.replace(B, function (b, d, e, f) {
      return qa(a, b, d, e, f);
    });return O(a, b);
  }function O(a, b) {
    for (var c; c = C.exec(b);) {
      var d = c[0],
          e = c[1];c = c.index;var f = b.slice(0, c + d.indexOf("@apply"));b = b.slice(c + d.length);var h = P(a, f),
          g,
          k,
          d = void 0;g = a;var e = e.replace(na, ""),
          n = [];k = g.a.get(e);k || (g.a.set(e, {}), k = g.a.get(e));if (k) for (d in g.c && (k.i[g.c] = !0), k.h) {
        g = h && h[d], k = [d, ": var(", e, "_-_", d], g && k.push(",", g), k.push(")"), n.push(k.join(""));
      }d = n.join("; ");b = "" + f + d + b;C.lastIndex = c + d.length;
    }return b;
  }
  function P(a, b) {
    b = b.split(";");for (var c, d, e = {}, f = 0, h; f < b.length; f++) {
      if (c = b[f]) if (h = c.split(":"), 1 < h.length) {
        c = h[0].trim();var g = a;d = c;h = h.slice(1).join(":");var k = oa.exec(h);k && (k[1] ? (g.b || (g.b = document.createElement("meta"), g.b.setAttribute("apply-shim-measure", ""), g.b.style.all = "initial", document.head.appendChild(g.b)), d = window.getComputedStyle(g.b).getPropertyValue(d)) : d = "apply-shim-inherit", h = d);d = h;e[c] = d;
      }
    }return e;
  }function ra(a, b) {
  ...
  function qa(a, b, c, d, e) {
    d && K(d, function (b, c) {
      c && a.a.get(c) && (e = "@apply " + c + ";");
        ...
        g = f = P(a, f),
        k = a.a.get(c),
        n = k && k.h;n ? g = Object.assign(Object.create(n), f) : a.a.set(c, g);var X = [],
        w,
        x,
        Y = !1;for (w in g) {
      x = f[w], void 0 === x && (x = "initial"), !n || w in n || (Y = !0), X.push("" + c + "_-_" + w + ": " + x);
    }Y && ra(a, k);k && (k.h = g);d && (h = b + ";" + h);return "" + h + X.join("; ") + ";";
  ...
  N.prototype.transformCustomStyle = N.prototype.f;N.prototype.transformRules = N.prototype.l;N.prototype.transformRule = N.prototype.g;N.prototype.transformTemplate = N.prototype.m;N.prototype._separator = "_-_";Object.defineProperty(N.prototype, "invalidCallback", { get: function get() {
    ...
    var a = this;this.a = null;this.b = !1;sa(function () {
      V(a);
    });T.invalidCallback = ja;
  }function V(a) {
    a.b || (a.a = window.ShadyCSS.CustomStyleInterface, a.a && (a.a.transformCallback = function (a) {
      T.f(a);
    ...
    V(this);l[b] = a;b = T.m(a, b);a._styleAst = b;
  };
  function W(a) {
    V(a);if (a.a) {
  ...
  U.prototype.styleElement = function (a) {
    V(this);var b = a.localName,
        c;b ? -1 < b.indexOf("-") ? c = b : c = a.getAttribute && a.getAttribute("is") || "" : c = a.is;if ((b = l[c]) && !A(b)) {
      if (A(b) || b._applyShimValidatingVersion !== b._applyShimNextVersion) this.prepareTemplate(b, c), ka(b);if (a = a.shadowRoot) if (a = a.querySelector("style")) a.__cssRules = b._styleAst, a.textContent = H(b._styleAst);
    }
  ...
  if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
    var Z = new U(),
      ...
      }, nativeCss: G, nativeShadow: ma };ta && (window.ShadyCSS.CustomStyleInterface = ta);
